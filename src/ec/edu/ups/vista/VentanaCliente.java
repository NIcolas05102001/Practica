...
public class VentanaCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnCerrar1.setForeground(new java.awt.Color(0, 0, 102));
        btnCerrar1.setText("Agregar Vehiculo");
    ...
    private void btnCerrar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCerrar1ActionPerformed
        String placa = v.getTxtPLaca().getText();
        String marca = v.getTxtMarca().getText();
        String modelo = v.getTxtModelo().getText();
        Ticket ticket = v.getT();
        Vehiculo vehiculo = new Vehiculo(title, title, title, ticket);
        String cedula = txtCedula.getText();
        String nombre = txtNombre.getText();
        String direccion = txtDireccion.getText();
        String telefono = txtTelefono.getText();
        Cliente c = new Cliente(cedula, nombre, direccion, telefono, vehiculo);
