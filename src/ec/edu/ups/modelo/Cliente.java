...
public class Cliente {
    ...
    public Cliente(String cedula, String nombre, String direccion, String telefono, Vehiculo vehiculo) {
        this.cedula = cedula;
        this.nombre = nombre;
    ...
    public String toString() {
        return "Cliente{" + "cedula=" + cedula + ", nombre=" + nombre + ", direccion=" + direccion + ", telefono=" + telefono + vehiculo + '}';
    }
